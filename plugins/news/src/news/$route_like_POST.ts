...
export default async function(ctx:Context,_session:Session|null,opts:{req:Request;params:Record<string,string>}){
 ...
 const req=new Request(`${url.origin}/news/reader/at?${params}`,{headers:{accept:"text/html","hx-request":"true","hx-target":"reader"}});return ctx.fns.procs.http.dispatch({req});
}
